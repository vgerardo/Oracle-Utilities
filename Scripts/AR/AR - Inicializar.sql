...
begin
    ...
    into v_user_id
    from fnd_user
    where user_name like 'ACCN-GVARGAS'
    ;

    SELECT distinct responsibility_id
    into v_resp_id
    FROM fnd_responsibility_tl
    WHERE RESPONSIBILITY_NAME LIKE 'GRP_ALL_CUS_CORP_CREA_RECIBOS_AR_CORP'
    ;
    ...
    --
    MO_GLOBAL.init('AR'); -- product short name

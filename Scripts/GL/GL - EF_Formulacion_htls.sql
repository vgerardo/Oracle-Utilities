--plus80 bolinf/welcome12@di_production @C:\EF_Formulacion.sql

SPOOL C:\EF_Hoteles.txt
...
FROM CSA_EF_HTLS_REPS  rep,
     CSA_EF_HTLS_CNCPT cnc,
     CSA_EF_HTLS_CNTAS cta,
     CSA_EF_HTLS_RFRNC rfr
WHERE 1=1

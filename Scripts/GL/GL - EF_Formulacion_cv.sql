...
--plus80 bolinf/welcome12@di_production @EF_Formulacion_cv.sql

SPOOL C:\EF_ClubVac_HVP.txt
...
FROM CSA_EF_CORP_REPS  rep,
     CSA_EF_CORP_CNCPT cnc,
     CSA_EF_CORP_CNTAS cta,
     CSA_EF_CORP_RFRNC rfr
WHERE 1=1

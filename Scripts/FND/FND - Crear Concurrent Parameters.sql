...
BEGIN
  --
  l_program_short_name      := 'GRP_PAY_TMBRDO_ESTATUS';
  l_application             := 'Grupo Posadas Custom Product';
  l_sequence                := 30;
  l_parameter               := 'p_archivo';
  l_description             := 'Nombre del archivo de amarre';
  l_enabled                 := 'Y';
  l_value_set               := '100 Characters';
  l_default_type            := NULL;
  ...
  l_concatenated_descr_size := 25;
  l_prompt                  := 'Archivo Amarre';
  l_token                   := NULL;
  l_cd_parameter            := NULL;
  --

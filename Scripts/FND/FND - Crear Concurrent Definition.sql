...
Crea la definición del CONCURRENTE
...
BEGIN
 ...
 l_program                   := 'GRP Pay Timbrado Conectum - Estatus';
  l_application              := 'Grupo Posadas Custom Product';
  l_enabled                  := 'Y';
  l_short_name               := 'GRP_PAY_TMBRDO_ESTATUS';
  l_description              := 'Reporte de Estatus de Timbardos de Nómina con NEXT TECHNOLOGIES';
  l_executable_short_name    := 'GRP_PAY_TMBRDO_ESTATUS';
  l_executable_application   := 'Grupo Posadas Custom Product';

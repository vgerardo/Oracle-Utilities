CREATE OR REPLACE package body bolinf.GRP_ZIP
--
...
is
--
  c_LOCAL_FILE_HEADER        constant raw(4) := hextoraw( '504B0304' ); -- ZIP local header, always equals 0x04034b50
